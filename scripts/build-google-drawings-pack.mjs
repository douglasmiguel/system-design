...
const components = [
  ...
  ["08-service-multiple", "Service · Multiple", "Several stateless service instances", "compute", '<rect x="92" y="104" width="94" height="88" rx="10"/><rect x="214" y="104" width="94" height="88" rx="10"/><path d="M92 132h94m28 0h94M116 151h46m76 0h46M116 170h30m92 0h30"/>'],
  ...
  ["12-sql-multiple", "SQL · Multiple", "Primary database with read replicas", "data", '<ellipse cx="130" cy="103" rx="44" ry="15"/><ellipse cx="270" cy="103" rx="44" ry="15"/><path d="M86 103v62c0 10 20 18 44 18s44-8 44-18v-62M86 135c0 10 20 18 44 18s44-8 44-18M226 103v62c0 10 20 18 44 18s44-8 44-18v-62M226 135c0 10 20 18 44 18s44-8 44-18M184 143h30m0 0-10-10m10 10-10 10"/>'],
  ...
  ["14-nosql-multiple", "NoSQL · Multiple", "Replicated or partitioned NoSQL nodes", "data", '<rect x="102" y="103" width="77" height="96" rx="8"/><rect x="211" y="103" width="77" height="96" rx="8"/><path d="M102 133h77m-77 30h77m32-30h77m-77 30h77M179 151h22m0 0-10-10m10 10-10 10"/>'],
  ...
  ["17-cache-cluster", "Cache Cluster", "Multiple cache nodes or shards", "async", '<rect x="106" y="105" width="74" height="91" rx="8"/><rect x="218" y="105" width="74" height="91" rx="8"/><path d="M106 136h74m38 0h74M131 157h24m88 0h24M180 151h26m0 0-10-10m10 10-10 10"/>'],
